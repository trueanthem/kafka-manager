...
libraryDependencies ++= Seq(
  ...
  "org.apache.curator" % "curator-framework" % "2.13.0" exclude("log4j","log4j") exclude("org.slf4j", "slf4j-log4j12") force(),
  "org.apache.curator" % "curator-recipes" % "2.13.0" exclude("log4j","log4j") exclude("org.slf4j", "slf4j-log4j12") force(),
  ...
  "org.apache.kafka" % "kafka-streams" % "2.4.0" % "test",
